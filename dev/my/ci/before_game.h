...
if (rdd == 0) {
    ...
    custom_objects[6].np=12;custom_objects[6].x=12;custom_objects[6].y=2;
	custom_objects[7].np=23;custom_objects[7].x=12;custom_objects[7].y=8;
} else if (rdd == 1) {
	...
	custom_objects[7].np=9;custom_objects[7].x=1;custom_objects[7].y=7;
} else {
	...
	custom_objects[7].np=8;custom_objects[7].x=12;custom_objects[7].y=2;
}
...
custom_objects[7].st=1;custom_objects[7].t=29;custom_objects[7].c=0;
