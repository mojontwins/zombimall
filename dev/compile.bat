...
..\utils\rle62map_sp.exe in=..\map\mapa.map mk1h=assets\mapa.h out=mapa size=3,11 tlock=15 mk1locks > nul
rem ..\utils\mapcnv.exe ..\map\mapa.map assets\mapa.h 3 12 15 10 15 packed > nul
...
zcc +zx -vn mk1.c -O3 -crt0=crt.asm -o %game%.bin -lsplib2_wan.lib -zorg=24000 > nul
