...
unsigned char player_move (void) {	
	...
	*/
    ...
    #include "my/ci/on_special_tile_floor.h"
	...
	#ifdef PLAYER_USE_OBJECTS
	    #include "my/ci/custom_player_use_objects.h"
	#endif
...
void player_deplete (void) {
	#ifdef USE_CUSTOM_LIFE_DECREASE
	    #include "my/ci/on_player_custom_life_decrease.h"
	#else
